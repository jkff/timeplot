...
showHelp = mapM_ putStrLn [ "",
  ...
  "               parse 12.4039 or 12,4039). Default:",
  "               'date %Y-%m-%d %H:%M:%OS'",
  ...
  "  'duration XXXX' - plot any kind of diagram over the *durations* of events",  "     on a track (delimited by > ... <), for example 'duration quantile",
